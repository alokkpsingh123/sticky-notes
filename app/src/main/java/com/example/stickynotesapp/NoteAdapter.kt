...
import com.example.stickynotesapp.databinding.NoteItemBinding

class NoteAdapter(private val onNoteClicked: (NoteResponse) -> Unit) : androidx.recyclerview.widget.ListAdapter<NoteResponse, NoteAdapter.NoteViewHolder>(ComparatorDiffUtil()){
